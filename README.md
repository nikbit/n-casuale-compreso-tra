...
> Apri questa pagina in [https://nikbit.github.io/n-casuale-compreso-tra/](https://nikbit.github.io/n-casuale-compreso-tra/)
...
* cerca **https://github.com/nikbit/n-casuale-compreso-tra** ed importa

## Modifica questo progetto ![Badge stato build](https://github.com/nikbit/n-casuale-compreso-tra/workflows/MakeCode/badge.svg)

Per modificare questa repository in MakeCode.

* apri [https://makecode.microbit.org/](https://makecode.microbit.org/)
* clicca su **Importa** quindi fai clic su **Importa INDIRIZZO**
* incolla **https://github.com/nikbit/n-casuale-compreso-tra** e clicca importa
...
![Un'immagine renderizzata dei blocchi](https://github.com/nikbit/n-casuale-compreso-tra/raw/master/.github/makecode/blocks.png)
